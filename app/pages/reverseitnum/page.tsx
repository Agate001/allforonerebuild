...
const page = () => {
  ...
  const [result, setResult] = useState("Enter Your Number");

  async function fetchReverseNum() {
    if (!number) {
      setResult("Number is required.");
      return;
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat bg-[url(/Assets/background.jpg)]">
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-5xl font-extrabold pb-4">(Number)</h1>
